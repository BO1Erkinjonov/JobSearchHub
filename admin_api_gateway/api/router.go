...
import (
	...
	"admin_api_gateway/api/middleware/casbin"
	"time"

	v1 "admin_api_gateway/api/handlers/v1"
	"admin_api_gateway/api/middleware"
	...
	grpcClients "admin_api_gateway/internal/infastructure/grpc_service_client"
...
func NewRoute(option RouteOption) *gin.Engine {
	...
	// Client
	api.POST("/create/client", HandlerV1.CreateClient)
	api.GET("/get/client", HandlerV1.GetClientById)
	api.GET("/get/all/client", HandlerV1.GetClientList)
	...
	api.DELETE("/delete/request", HandlerV1.DeleteRequest)
